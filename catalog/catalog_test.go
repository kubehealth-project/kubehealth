...
func TestCatalogRegistersIntegrations(t *testing.T) {
	...
	objects := []*unstructured.Unstructured{
		...
		resource("pkg.crossplane.io/v1", "Provider"),
		resource("apiextensions.crossplane.io/v1", "Composition"),
		resource("external-secrets.io/v1", "ExternalSecret"),
		resource("external-secrets.io/v1", "ClusterExternalSecret"),
		resource("external-secrets.io/v1", "SecretStore"),
		resource("external-secrets.io/v1", "ClusterSecretStore"),
		resource("external-secrets.io/v1alpha1", "PushSecret"),
		resource("gateway.networking.k8s.io/v1", "GatewayClass"),
		resource("gateway.networking.k8s.io/v1", "Gateway"),
		resource("gateway.networking.k8s.io/v1", "HTTPRoute"),
		resource("gateway.networking.k8s.io/v1", "GRPCRoute"),
		resource("gateway.networking.k8s.io/v1", "BackendTLSPolicy"),
		resource("kyverno.io/v1", "Policy"),
		resource("kyverno.io/v1", "ClusterPolicy"),
		resource("kyverno.io/v2beta1", "Policy"),
		resource("kyverno.io/v2beta1", "ClusterPolicy"),
